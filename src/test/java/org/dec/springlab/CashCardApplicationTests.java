package org.dec.springlab;

import com.jayway.jsonpath.DocumentContext;
import com.jayway.jsonpath.JsonPath;
import net.minidev.json.JSONArray;
import org.dec.springlab.controller.CashCard;
...
class CashCardApplicationTests {
    ...
    @Test
    void shouldnotReturnCashcardWithUnknownIdTest(){
        ResponseEntity<String> response = restTemplate.withBasicAuth("sarah1", "abc123")
    ...
    void shouldCreateANewCashCard() {
        ...
        ResponseEntity<Void> createResponse = restTemplate.withBasicAuth("sarah1", "abc123")
                .postForEntity(
                "/cashcards", newCashCard, Void.class);
